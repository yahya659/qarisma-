...
import Explore_More_About_Health from './components/Explore_More_About_Health';
import Health_programs_Topics from './components/Health_programs_Topics';
...
export default function page() {
  ...
  <div className="relative w-full">
   ...
   <Explore_More_About_Health/>
   <Health_programs_Topics/>
    <Footer/>
  </div>
