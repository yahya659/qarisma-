...
export default function Discover_Filters_Section() {
  ...
  const tabs = [
    { name: "All", path: "" },
    { name: "Music", path: "/entertainment/article/page_music" },
    { name: "Movies", path: "/entertainment/article/Movies" },
    { name: "Food", path: "/entertainment/article/Food" },
    { name: "Celebrity", path: "/entertainment/article/Celebrity" },
