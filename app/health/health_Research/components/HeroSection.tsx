...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[500px] md:h-[100vh] bg-[#F178B6CC]/80 overflow-hidden shadow-2xl">
      {/* Background Image (Using a stylized stage/neon image to match the vibe) */}
      <div
        className="absolute inset-0 bg-cover bg-center opacity-60   "
        style={{
          backgroundImage: 'url("/images/health_Research/Research1.jpg")',
        }}
      />
      ...
      <div className="relative h-[541px] mt-10 max-w-6xl bg-[#F178B6CC]/52 mx-auto px-6 flex flex-col justify-center items-start text-white">
        <h1 className="text-4xl md:text-5xl text-[#000000] font-extrabold mb-4 leading-tight tracking-wide drop-shadow-lg">
