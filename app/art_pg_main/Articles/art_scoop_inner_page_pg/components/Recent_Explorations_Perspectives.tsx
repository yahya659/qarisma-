...
export default function Recent_Explorations_Perspectives() {
  const liveSessions = [
    {
      id: 1,
    ...
    <>
      <main className="relative z-10 max-w-7xl mx-auto px-4  md:px-8 pb-20">
        <section className="mb-24 ">
          ...
          Recent Explorations & Perspectives
          </h2>
          ...
          <div className="flex justify-center mt-12">
            <button className="bg-[#5D5FEF85]/64   px-20 py-4 rounded-2xl font-bold transition-all shadow-xl hover:shadow-pink-400/40 active:scale-95 text-[48px]">
              View all
            </button>
          </div>
        </section>
