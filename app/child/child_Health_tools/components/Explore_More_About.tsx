...
export default function Explore_More_About() {
  return (
    <>
      {/* Child Development & Mental Health Section */}
      <section className="text-center py-10 px-4 sm:px-6 lg:px-8">
        <h2 className="text-[40px]  text-[#000000] md:text-5xl  font-black mb-2">
          Explore More About
        </h2>

        <p className="text-base sm:text-lg md:text-xl lg:text-[30px] opacity-80 max-w-xl text-[#FFFFFF] font-bold mx-auto mb-10">
        ...
        <button className="mt-8 bg-[#F178B6] w-full sm:w-auto sm:max-w-[306px] text-[36px] lg:text-[36px] h-auto sm:h-[60px] md:h-[77px] text-[#FFFFFF] px-6  rounded-[25px] font-bold shadow-lg hover:scale-105  ">
         Explore more
        </button>
      </section>
    </>
