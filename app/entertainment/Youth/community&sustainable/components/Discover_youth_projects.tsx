      ...
      <section className="py-12 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
          ...
          {projects.map((p, idx) => (
            <div
              key={idx}
              className="bg-[#5D5FEF30] backdrop-blur-md   overflow-hidden border border-white/20 shadow-2xl hover:scale-[1.03] transition-transform duration-500 group"
            >
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="px-6 py-2 bg-[#5D5FEF82] hover:bg-blue-700 text-white rounded-xl text-[20px] font-bold transition-all shadow-md active:scale-95">
                    Read more
                  </button>
                </div>
              </div>
