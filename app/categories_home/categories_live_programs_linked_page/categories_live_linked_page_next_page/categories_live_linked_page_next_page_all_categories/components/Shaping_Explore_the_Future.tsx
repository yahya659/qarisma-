...
export default function Shaping_Explore_the_Future() {
  return (
    <>
<section
  className="px-4 sm:px-6 py-12 sm:py-16 w-full mx-auto"
  style={{
    background:
      "linear-gradient(270deg, rgba(93, 95, 239, 0.592) 0%, rgba(93, 95, 239, 0.416) 51.44%, rgba(241, 120, 182, 0.512) 99.52%)",
  }}
>        <div className="text-center mb-10 sm:mb-12 px-2">
          <h2 className="text-[40px]  font-bold mb-2 leading-tight">
            Shaping & Explore more about
          </h2>
          <span className="text-[#5D5FEF] font-bold text-[48px]">
            our programs
          </span>
        </div>
