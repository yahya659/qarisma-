      ...
      <section className="px-8 lg:px-16 mb-10 flex flex-wrap gap-4">
        <div className="relative flex-1 min-w-[410px]">
          ...
          <input
            ...
            className="w-full bg-[#F178B6A3]/60  backdrop-blur-md  rounded-xl py-3 pl-12 pr-4 text-[24px] focus:outline-none focus:ring-2 ring-purple-500 transition-all placeholder:text-[#FFFFFF]"
          />
        </div>
        <button className="px-6 text-[#5D5FEF] w-[240px] text-[24px] py-3 bg-white/10 backdrop-blur-md   rounded-xl flex items-center gap-3 ">
          Status all <ChevronDown size={16} />
        </button>
        <button className="px-6 py-3 text-[#5D5FEF] text-[24px] bg-white/10 w-[292x] backdrop-blur-md   rounded-xl flex items-center gap-3  ">
