export default function HeroSection() {
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-30 px-4 sm:px-8 md:px-16">
    ...
    {/* CTA Button */}
    <button className="w-full max-w-xs sm:max-w-sm md:max-w-md bg-[#F178B6A6] py-3 px-6 text-white font-bold text-base sm:text-lg md:text-xl lg:text-[24px] shadow-xl hover:bg-[#4d4fd9] transition rounded-lg">
      Watch More
    </button>
