    ...
    <>
      ...
      <section className="px-4 sm:px-6 py-12 sm:py-16 max-w-7xl mx-auto">
        <div className="text-center mb-10 sm:mb-12 px-2">
          <h2 className="text-[28px] sm:text-[36px] md:text-[48px] font-bold mb-2 leading-tight">
            Vision Of{" "}
            <span className="text-[#F178B6] text-[28px] sm:text-[36px] md:text-[48px] font-black">
              Latest stories
            </span>
          </h2>

          <p className="text-white/60 text-[16px] sm:text-[24px] md:text-[32px]">
