        ...
        <div className="max-w-7xl mx-auto px-6 h-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center h-full">
            <div className="space-y-8">
              ...
              <button className="bg-[#F178B6A3]/60 hover:bg-pink-300 text-white px-12 py-5 rounded-2xl font-black text-[40px] shadow-[0_10px_30px_rgba(236,72,153,0.3)] transition-all transform hover:scale-105">
                View More
              </button>
            </div>
