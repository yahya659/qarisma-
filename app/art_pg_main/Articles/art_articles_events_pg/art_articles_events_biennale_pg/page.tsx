...
// import Beyond_Headlines from './components/The_Language_Light_and_Shadow';

export default function art_articles_events_biennale_pg() {
  return (
     <>
             {" "}
             <Header />
