  ...
  return (
    <>
      <section className="px-6 pt-12 pb-8">
        <div className="max-w-5xl mx-auto bg-blue-600/90 rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 mb-16 shadow-lg shadow-blue-500/20">
          <p className="font-bold text-sm md:text-lg">
            stay informed, learn more & contact us
          </p>
          <button className="bg-pink-400 hover:bg-pink-500 px-8 py-2 rounded-xl text-white font-bold transition-colors whitespace-nowrap">
            read messages
          </button>
        </div>
