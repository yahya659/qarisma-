    ...
    <>
      <section className="max-w-6xl mx-auto px-4 mb-20">
        <div className="text-center mb-10">
          <h2 className="text-[35px] font-bold">Marketing</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[1, 2, 3].map((item) => (
            <div
              key={item}
              className="bg-white/10 p-6 rounded-3xl border border-white/10 text-center"
            >
              ...
              <p className="text-gray-400 text-xs">
                Building impactful relationships and managing communication
                channels.
              </p>
            </div>
          ))}
