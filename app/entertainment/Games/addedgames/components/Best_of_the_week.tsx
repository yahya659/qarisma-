...
export default function Best_of_the_week() {
  return (
     <section className="relative z-10 py-16 text-center max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-black text-black mb-12 tracking-wide">Best of the week</h2>
            ...
            <div className="hidden md:flex w-72 rounded-xl shadow-xl bg-[#5D5FEF6E] opacity-80 scale-95 transition-transform flex-row">
                ...
                <div className="flex-1 flex flex-col py-2">
                   <div className="h-32 relative px-2 mb-2">
                     <img src="/images/entertainment/Games1.jpg" alt="Game" className="w-full h-full object-cover rounded-md border border-white/20" />
                   </div>
                   <div className="px-3 pb-2 bg-[#C0A9E7] flex-1">
                     <p className="text-[15px] text-white/95 leading-tight font-medium text-left">It has one principle and one motto that can be read individually, meaning each word on its own, or as a whole, we believe that reality and maturity are core for truth</p>
                   </div>
                </div>
            ...
            <div className="w-80 rounded-xl shadow-2xl bg-[#F48BBE] z-10 transform scale-105 flex-row flex">
                ...
                <div className="flex-1 flex flex-col py-3">
                   <div className="h-40 relative px-2.5 mb-3">
                     <img src="/images/entertainment/Games1.jpg" alt="Game" className="w-full h-full object-cover rounded-md border border-white/30 shadow-sm" />
                   </div>
