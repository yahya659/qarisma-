...
//     <p className="text-pink-300 text-[11px] font-black uppercase tracking-[0.2em] mb-3">
//       {role}
//     </p>
...
import Public_Relations from "./components/Public_Relations";
import Marketing from "./components/Marketing";
import Social_Media_Management from "./components/Social_Media_Management";
import Article_Editors from "./components/Article_Editors";
import UI_UX_Design from "./components/UI_UX_Design";
import Front_EndDevelopment from "./components/Front_EndDevelopment";
import Back_EndDevelopment from "./components/Back_EndDevelopment";
import Database_Cybersecurity from "./components/Database_Cybersecurity";
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen font-sans text-white selection:bg-[#5D5FEF6E]">
        ...
        <div className="fixed inset-0 -z-10 bg-gradient-to-br from-[#5D5FEF24] via-[#a380ce] to-[#d89fd1]" />
        ...
        <div className="relative w-full">
          ...
          <div
            ...
            style={{
              backgroundImage: "url('/images/teams.png')",
            }}
          />
...
<Marketing/>
       ...
       <Article_Editors/>
       <UI_UX_Design/>
       <Front_EndDevelopment/>
       <Back_EndDevelopment/>
       <Database_Cybersecurity/>
          <Footer />
        </div>
      </div>
    </>
