        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          ...
          <div className="grid grid-cols-2 gap-x-10 md:gap-x-16 gap-y-4">
            <div className="flex flex-col gap-3">
              <Link
                href="/news"
                className="text-white text-base md:text-xl hover:text-gray-200 transition"
              >
                News
              </Link>
              <Link
...
function SocialButton({
  ...
  return (
    <button
      className={`${color} w-10 h-10 rounded-full flex items-center justify-center text-white text-xl shadow-md hover:scale-110 transition-transform active:scale-90`}
    >
      {icon}
    </button>
  );
