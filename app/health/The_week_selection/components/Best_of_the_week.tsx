        ...
        <div className="flex items-center justify-center gap-4 md:gap-10 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 flex-1">
            {[1, 2, 3].map((idx) => (
              <div
                key={idx}
                className={`bg-[#F178B64D]   overflow-hidden shadow-2xl flex flex-col transform transition-all ${idx === 2 ? "scale-110 z-20 ring-4 ring-pink-400" : "opacity-80 scale-95  "}`}
              >
                ...
                <div className="p-4 bg-[#D3AEDB] flex-1">
                  <p className="text-[13px] text-[#FFFFFF] font-bold leading-tight mb-4 text-left">
