...
export default function Joinour_community() {
  ...
  <section className="text-center mb-16 relative py-8 sm:py-10 md:py-12 bg-[#5D5FEF85]/50">

    {/* Decorative Butterflies (Visual simulation) */}
    <div className="absolute bottom-[-20%] right-[-30%] sm:right-[-25%] md:right-[-31%] w-[120px] h-[120px] sm:w-[200px] sm:h-[200px] md:w-[350px] md:h-[350px] lg:w-[600px] lg:h-[600px] z-40 pointer-events-none">
