...
export default function Top_story() {
  return (
    <>
      <section className="bg-[#87147A] w-full max-w-[1263px] min-h-[617px] p-6 md:p-8 mb-12 mx-auto flex flex-col md:flex-row items-center justify-center gap-8 relative overflow-hidden shadow-xl">
        ...
        <div className="w-full md:w-1/2 text-white z-10 text-center md:text-left flex flex-col items-center md:items-start">
          <h2 className="text-[#000000] sm:text-5xl md:text-[64px] font-bold mb-4 capitalize opacity-90">
            Beyond Headlines
          </h2>
          ...
          <button className="  hover:bg-blue-700 text-[36px] text-[#000000] px-6 md:px-8 py-3 font-bold transition-all transform hover:scale-105 shadow-md">
            Watch Live
          </button>
        </div>
      </section>
