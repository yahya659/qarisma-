      ...
      <div className="relative min-h-screen bg-[#BD9FA9]/80 text-white font-sans p-4 md:p-8 overflow-x-hidden">
        ...
        <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
          {[1, 2, 3, 4].map((item) => (
            <div
              key={item}
              className="relative aspect-[4/3] rounded-2xl overflow-hidden border-4 border-yellow-700/40 shadow-xl group"
            >
              <img
                src="/images/NEWSS.jpg"
                alt="Story"
        ...
        <footer className="flex justify-center items-center gap-4 pb-12">
          ...
          <div className="flex gap-2">
            <button className="w-12 h-12 bg-white text-[#6366F1] font-bold rounded-xl shadow-inner">
              1
            </button>
            <button className="w-12 h-12 bg-[#6366F1]/40 text-white font-bold rounded-xl shadow-lg">
              2
            </button>
            <button className="w-12 h-12 bg-[#6366F1]/40 text-white font-bold rounded-xl shadow-lg">
              3
