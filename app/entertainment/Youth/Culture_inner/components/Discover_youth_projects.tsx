  ...
  return (
    <>
      ...
      <section className="py-12 px-6 max-w-7xl mx-auto">
        <div className="mb-10">
          <h2 className="text-[48px] text-[#5D5FEF] font-bold mb-2">
            Discover youth projects
          </h2>
          <p className="text-[40px] opacity-80 mb-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="relative w-full md:w-80 group">
              <input
                ...
                className="w-full px-6 py-3 rounded-2xl bg-white text-gray-700 focus:outline-none shadow-xl border-2 border-transparent focus:border-pink-300 transition-all"
              />
              <Search
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
          ...
          {projects.map((p, idx) => (
            <div
              key={idx}
              className="bg-white/15 backdrop-blur-md rounded-[35px] overflow-hidden border border-white/20 shadow-2xl hover:scale-[1.03] transition-transform duration-500 group"
            >
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="px-6 py-2 bg-[#F178B6A3] hover:bg-blue-700 text-white rounded-xl text-[20px] font-bold transition-all shadow-md active:scale-95">
                    Read more
                  </button>
                </div>
              </div>
        ...
        <div className="flex justify-center mt-16">
          <button className="px-12 py-3 bg-[#F178B6] hover:bg-pink-500 text-white rounded-2xl font-bold text-[#F178B6] shadow-xl shadow-pink-400/20 transition-all active:scale-95">
            Add your project
          </button>
        </div>
      </section>
