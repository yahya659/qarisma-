    ...
    <>
      <div className="relative z-10 flex flex-col items-center max-w-lg w-full text-center">
        ...
        <div className="w-full max-w-md mb-12 relative group">
          ...
          <div className="relative w-[719px] right-30 h-[200px]">
            <Image
        ...
        {/* الأزرار (Glassmorphism) */}
        <div className="flex w-full gap-4 max-w-sm">
          <button className="flex-1 bg-[#F178B6]/38 backdrop-blur-md border border-white/20 py-4 rounded-md font-bold text-lg hover:bg-white/20 transition-all active:scale-95 shadow-lg flex items-center justify-center gap-2">
            Next
          </button>
          <button className="flex-1 bg-[#F178B6]/38 backdrop-blur-md border border-white/20 py-4 rounded-md font-bold text-lg hover:bg-white/20 transition-all active:scale-95 shadow-lg flex items-center justify-center gap-2">
            Sign in
