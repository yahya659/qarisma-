...
export default function HeroSection() {
  return (
     <>  <section className="bg-[#87147A] w-full  min-h-[100vh] p-6 md:p-8 mb-12 mx-auto flex flex-col md:flex-row items-center justify-center gap-8 relative overflow-hidden shadow-xl">
