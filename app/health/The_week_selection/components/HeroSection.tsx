  ...
  return (
    <section className="relative w-full h-[500px] md:h-[100vh] bg-indigo-950 overflow-hidden shadow-2xl">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("/images/The_week_selection/The_week_selection1.png")',
        }}
      />
      ...
      <div className="relative h-full max-w-6xl mx-auto px-6 flex flex-col justify-center items-start text-white">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4 leading-tight tracking-wide drop-shadow-lg">
          Explore your <br />
          <span className="text-[#000000]">Explore your way to health wit us</span>
        </h1>
        ...
        <button className="px-8 py-3 bg-[#5D5FEF] hover:bg-[#5741E0] text-white font-bold rounded-lg shadow-lg transition-all transform hover:scale-105">
          Read More
        </button>
      </div>
    </section>
