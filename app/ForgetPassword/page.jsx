...
export default function ForgetPasswordPage() {
  return (
    ...
    <main className="min-h-screen w-full flex items-center justify-center p-4 bg-cover bg-center bg-no-repeat">
      <div className="absolute inset-0 z-0 bg-[#BD9FA966]">
        <img
          src="images/interveo.png"
          alt="Background"
          className="w-full h-full object-cover grayscale-[20%] brightness-75 opacity-20"
        />
      </div>
      <div className="absolute top-[ ]   left-2 w-[661px] h-[600px] bg-[#BD9FA966]  opacity-30   ">
        {/* الفراشه */}
        <img
      ...
      <div className="w-full max-w-[640px] backdrop-blur-md bg-[#1976D224]/14 rounded-3xl p-12 flex flex-col items-center border border-white shadow-[0_0_20px_rgba(255,255,255,0.2)]">
        ...
        <div className="w-full mb-8">
          <button
            type="submit"
            className="w-full h-14 rounded-xl bg-[#F6F6F6] text-gray-950 text-[24px] font-semibold hover:bg-gray-200 transition duration-150 shadow-sm"
          >
            Send Reset Link
          </button>
        </div>
        ...
        <div className="text-[20px] text-[#00052B] mb-12">
