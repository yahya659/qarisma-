      ...
      <div className="mb-16">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 flex-1">
            ...
            {/* Card 3 (Featured) */}
            <div className="bg-[#F178B699]  overflow-hidden shadow-lg border-2 border-pink-400 transform transition-transform hover:-translate-y-1 scale-105 z-10">
              ...
              <div className="p-5 bg-[#F178B699]/60 text-white">
                <p className="text-[20px] font-semibold mb-4">
                  It has one principle and one motto that can be read
                  individually, meaning each word on its own, or as a whole, we
                  believe that reality and maturity are core for truth
                </p>
                <button className="bg-[#5D5FEF] text-[16px] font-bold px-4 py-1.5 rounded-md hover:bg-[#5741E0] float-right">
                  Read More
                </button>
              </div>
            </div>
