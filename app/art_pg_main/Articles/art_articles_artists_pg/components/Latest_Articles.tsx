    ...
    <>
      ...
      <section className="max-w-[1396.14453125] h-auto mx-auto px-4 mt-32">
        ...
        <div className="flex justify-center mt-16 p-20">
          <button className="bg-[#F178B69C]  hover:bg-pink-500 w-[457px] text-[#5D5FEF] font-bold py-4 px-12   shadow-lg transform transition active:scale-95">
            Learn More
          </button>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-20 mb-20">
        <div className="flex items-center justify-center gap-4">
          ...
          <button className="w-14 h-14 bg-indigo-500 rounded-2xl flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-indigo-200">
            1
          </button>
          <a href="/art_pg_main/Articles/art_articles_artists_pg/art_articles_artists_inner_pages_pg"> <button className="w-14 h-14 bg-indigo-400/50 rounded-2xl flex items-center justify-center text-white text-2xl font-bold">
            2
          </button></a>
